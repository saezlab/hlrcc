...
tp_file <- '/Users/emanuel/Projects/projects/hlrcc/files/b1368p100_protein_human_processed.tab'
tp_file_res <- '/Users/emanuel/Projects/projects/hlrcc/files/b1368p100_protein_human_limma.tsv'
